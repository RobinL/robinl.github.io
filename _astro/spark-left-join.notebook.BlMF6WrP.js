const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["_astro/spark-ui.DnheS6wu.js","_astro/NotebookCellProvider.BvOhHDPU.js","_astro/preload-helper.zoZ8CRZ9.js","_astro/index.CBFZI7UH.js","_astro/step.BThr63Mb.js"])))=>i.map(i=>d[i]);
import{_ as u}from"./preload-helper.zoZ8CRZ9.js";function l(t,e=()=>null){const a=t.module();l.FileAttachment&&a.variable().define("FileAttachment",[],()=>l.FileAttachment);for(const o of l.cells){const i=o.inputs??[],r=o.output;if(o.outputs?.length){const s=`cell ${o.id}`;a.variable(e(null)).define(s,i,o.body);for(const n of o.outputs)a.variable(!0).define(n,[s],d=>d[n])}else if(r)if(o.autoview){const s=r.slice(7),n=`viewof ${s}`;a.variable(e(n)).define(n,i,o.body),a.variable(e(s)).define(s,["Generators",n],(d,h)=>d.input(h))}else a.variable(e(r)).define(r,i,o.body);else a.variable(e(null)).define(i,o.body)}return a}Object.assign(l,{title:"Understanding the Spark UI by example: the Left Join",FileAttachment:void 0,cells:[{id:1,mode:"js",body:async()=>{const{leftJoinHtml:t,renderSparkPlan:e,renderSparkMetadata:a,sparkStyles:o}=await u(()=>import("./spark-ui.DnheS6wu.js"),__vite__mapDeps([0,1,2,3,4])).then(i=>{if(!("leftJoinHtml"in i))throw new SyntaxError("export 'leftJoinHtml' not found");if(!("renderSparkPlan"in i))throw new SyntaxError("export 'renderSparkPlan' not found");if(!("renderSparkMetadata"in i))throw new SyntaxError("export 'renderSparkMetadata' not found");if(!("sparkStyles"in i))throw new SyntaxError("export 'sparkStyles' not found");return i});return{leftJoinHtml:t,renderSparkPlan:e,renderSparkMetadata:a,sparkStyles:o}},inputs:[],outputs:["leftJoinHtml","renderSparkPlan","renderSparkMetadata","sparkStyles"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:2,mode:"js",body:(t,e)=>(t(e`# Understanding the Spark UI by example: the Left Join`),{title:null}),inputs:["display","md"],outputs:["title"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:3,mode:"js",body:(t,e)=>(t(e`
...
`),{intro:null}),inputs:["display","md"],outputs:["intro"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:4,mode:"js",body:()=>({exchange:"Spark has seen the left join on `dest`.  In order to perform this join, data needs to be sorted by the `dest` column.  Spark uses a hash partition using the default 200 shuffle partitions (see original tooltip) to split the data between executors.  The data from both the `parquet` and the `csv` file will be hashpartitioned on the `dest` field. This means data from the same `dest` ends up on the same executor node (computer), meaning that this part of data can be joined without further shuffles.\n\nThis process will work well if the data is evenly distributed across `dest` values. We can get an indication of whether this is the case from the timings: if the maximum timing is much greater than the median, we probably have a problem."}),inputs:[],outputs:["exchange"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:5,mode:"js",body:t=>({annotations:{cluster_7:`Spark has generated optimised Java code that combines three operations:  read the data, filter it, and select the requested columns (project).  Since the incoming data is in multiple files, Spark will be able to perform these operations in parallel.
...
`),{parallelisation:null}),inputs:["display","md"],outputs:["parallelisation"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:8,mode:"js",body:(t,e)=>(t(e`## Other parts of the Spark UI
...
`),{other_parts:null}),inputs:["display","md"],outputs:["other_parts"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:11,mode:"js",body:(t,e)=>(t(e`## References and useful resources:
...
`),{references:null}),inputs:["display","md"],outputs:["references"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:12,mode:"js",body:(t,e)=>(t(e()),{mystyles:null}),inputs:["display","sparkStyles"],outputs:["mystyles"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]},{id:13,mode:"js",body:(t,e,a)=>(t(e(a)),{metadata:null}),inputs:["display","renderSparkMetadata","leftJoinHtml"],outputs:["metadata"],output:void 0,display:!0,autodisplay:!1,autoview:void 0,files:[]}]});export{l as default};
