...
- Model 1 achieves recall (a true positive rate) of around 40%
- Model 2 achieves recall (a true positive rate) of around 53%
- Model 3 achieves recall (a true positive rate) of around 59%
- Model 4 achieves recall (a true positive rate) of around 67%
