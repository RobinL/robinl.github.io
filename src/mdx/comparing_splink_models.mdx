...
For example, this allows a term-frequency adjustment to be made for a fuzzy match of `Robin` vs `Robim` (note the typo). The weight moderates the strength of this term freuqncy downwards by a fixed multiple.
