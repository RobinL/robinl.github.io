...
## Computing the prediction step by step
    ...
    <InteractiveCallout>The following tables are interactive!  Edit the values and all the calculations in the rest of this article will update.</ InteractiveCallout>
