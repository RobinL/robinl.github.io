...
Where there’s genuine duplication of data processing and unnecessary differences in measures, improvements in infrastructure are rarely sufficient to eliminate them. The harder problem is usually navigating the organisational politics of gaining agreement for some users to change their ways of working and measures.  This is often a multi-year project, and a ‘central planning’ approach might not be the best way to keep stakeholders on side.
...
In a nutshell, the recipe for success is to have small delivery teams working on specific problems with well-defined business value.  Data leaders explicitly recognise that the organisation’s data problems are too complex for any one person to understand and solve. Teams are therefore empowered by a flexible range of tools, and are given the freedom to find innovative solutions themselves.  This provides a sustainable model for the delivery of real business value and continuous improvement.
