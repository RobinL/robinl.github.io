...
For example, consider how the token 'front' is the only token that appears just once amongst the candidates.
  ...
  candidates={[
    {
      address: (
        <>
          Flat Ground Floor <mark>Front</mark>, 57, Fulham Park Gardens, London
          SW6 4LB
        </>
      ),
      isMatch: true,
    },
    {
      address: (
        <>
          Flat First Floor, 57, Fulham Park Gardens, London
          SW6 4LB
        </>
      ),
      isMatch: false,
    },
    {
      address: (
        <>
          Flat Ground Floor, 66, Fulham Park Gardens, London SW6 4LB
        </>
      ),
      isMatch: false,
    },
    {
      address: (
        <>
          Flat Ground Floor Rear, 57, Fulham Park Gardens, London SW6 4LB
        </>
      ),
      isMatch: false,
    },
