...
<AddressCandidatesComparison
  ...
  candidates={[
    {
      address: <>Basement A, Block 1 Primrose Apartments, London</>,
      isMatch: false,
    },
    {
      address: <>Flat A, Block 1 Primrose Apartments, London</>,
      isMatch: true,
    },
    {
      address: <>Flat A, Block 2 Primrose Apartments, London</>,
      isMatch: false,
    },
    {
      address: <>Flat A, 1 Primrose Street, London</>,
      isMatch: false,
    },
    {
      address: <>Flat A, 2 Primrose Street, London</>,
      isMatch: false,
    },
  ]}
/>
...
In this case, 'Flat' does not help discriminate between most of the candidates, because there are many flats, so token frequencies do not help much.

However, :
- the _absence_ of `Flat` in the `Basement` address strongly suggests this cannot be the match, particularly because we know the word 'flat' exists in other addresses but not this one.
- the _absenece_ of 'Apartments' strongly suggests that candidate 4 cannot be the match, particularly because we know the word 'Apartments' exists in other addresses but not this one.
