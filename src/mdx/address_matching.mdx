...
### Surmounting problems of common words: n-grams combined with term frequencies
...
### Word order: Single words sorted by term frequency
...
### Narrowing down postcode using numerics
