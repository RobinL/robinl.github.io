...
Since Anthropic’s release of Opus 4.5 there seems to be a growing acceptance that LLM generated output can be good enough for serious production code. With this change in sentiment, AI tooling looks set to quickly become a normal part of software development.
