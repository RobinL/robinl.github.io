...
This post contains some fairly disorganised thoughts and questions on the short term (maybe 0 - 3 years)[^1] effects of LLMs on knowledge workers - particularly in organisation that embrace the use of LLMs.
...
From this experience, my overall sense is that LLMs represent a truly transformational technological breakthrough, similar in scale to the internet, in that they will completely transform the way we interact with information.  For example, I rarely use Google any more.