...
Serving data as a static file is probably the simplest and cheapest architecture. Modern cloud services mean it’s as simple as uploading the file to blob storage (e.g. AWS S3). Data access will [remain performant even if traffic is high](https://docs.aws.amazon.com/AmazonS3/latest/userguide/optimizing-performance.html), and the service will have very high reliability and availability. All of this is taken care of by the cloud provider.
