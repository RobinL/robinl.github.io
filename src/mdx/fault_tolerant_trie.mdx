---
title: "Fault tolerant trie"
description: "Fault tolerant trie for address matching"
...
These can be represented as a trie as follows:
...
- You may skip superfluous tokens at the start of messy address if you've already hit a terminal node, and that terminal node does not have children.
...
We can lookup a messy address in the trie as follows.  Again, this is ✨interactive✨.
