---
title: "Quotes, links and podcasts"
...
<ContentFilter key="content-filter">
    ...
    <LinkCard
        ...
        description="Hacker News discussion about companies moving from Apache Spark to DuckDB"
        date="2024-12-14"
        tags={["duckdb", "data"]}
    />
    ...
    <LinkCard
        ...
        description="DuckDB's approach to handling concurrent transactions for analytics workloads"
        date="2024-10-30"
        tags={["duckdb"]}
    />
