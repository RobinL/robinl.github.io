...
The most obvious way to predict whether these records represent the same entity is to measure whether the columns contain the same or similar information.
