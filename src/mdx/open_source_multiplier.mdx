...
Cities bring people together physically for collaboration resulting in network effects that boost productivity. Open source software projects enjoy similar network effects, which happen virtually, creating an informal community of experts around the world who share an interest in solving a particular and often highly-specific problem.  Each interaction within this community is only a small productivity multiplier, but they compound to make dramatic overall gains. A virtuous cycle can be established whereby as the quality of the open source project increases, more users are attracted into the network.
...
The remainder of this post presents some charts to illustrate the strength of the community
