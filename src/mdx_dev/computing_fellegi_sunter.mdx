...
## Computing the prediction step by step
    ...
    We now look up the partial match weights from the comparison vector.  I've also added the <DefinitionToolTip term="prior" />, expressed as a partial match weight, and finally the sum:
