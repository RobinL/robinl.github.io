...
R is perhaps the closest, because it has `data.frame` as a 'first class citizen', but most people don't seem to use it, and use e.g. `tibble`s from dplyr instead, or `data.table`.
