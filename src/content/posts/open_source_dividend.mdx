...
postDate: "2023-03-09"
category: "data"
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/open_source_dividend.mdx"
latestUpdate: "2024-09-02"
pageWidth: "prose"
---
...
<VegaLite client:visible spec={distinct_external_commentors} />
...
<VegaLite client:visible spec={cumulative_external_comment_count} />
...
<VegaLite client:visible spec={cumulative_external_prs} />
...
<VegaLite client:visible spec={cumulative_stars} />
...
<VegaLite client:visible spec={monthly_downloads_by_release} />

<VegaLite client:visible spec={cumulative_download_count} />
...
If you are a Splink user, please do get in touch - we'd love to hear from you about how you've used it - email robinlinacre@hotmail.com or put in a PR like [this one](https://github.com/moj-analytical-services/splink/pull/2363) to be included in the [use cases](https://moj-analytical-services.github.io/splink/#use-cases) section of the docs.
