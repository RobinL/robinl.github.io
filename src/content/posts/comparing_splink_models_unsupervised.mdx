...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/comparing_splink_models_unsupervised.mdx"
...
<VegaLite client:visible spec={roc_comparison_cluster} />
...
<VegaLite client:visible spec={roc_comparison_no_cluster} />
...
<VegaLite client:visible spec={iterations} />
...
<VegaLite client:visible spec={comp_1} />

### Model 2

<VegaLite client:visible spec={comp_2} />

### Model 3

<VegaLite client:visible spec={comp_3} />

### Model 4

<VegaLite client:visible spec={comp_4} />

### Model 5

<VegaLite client:visible spec={comp_5} />
