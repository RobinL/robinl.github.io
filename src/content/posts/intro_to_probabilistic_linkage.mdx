...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/notebooks/migrated/intro-prob-linkage/3ec7a740cff5f9ad@84.notebook.html"
...
<NotebookCellProvider client:visible notebook="intro-prob-linkage">
    ...
    <NotebookCell cellName="estimated_probability" />
    ...
    <NotebookCell cellName="waterfall_chart" />
