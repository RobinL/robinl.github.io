...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/notebooks/migrated/bf-prior-calc/695eee6aed606401@287.notebook.html"
...
<NotebookCellProvider client:visible notebook="bf-prior-calc">
    #### Prior
    <NotebookCell cellName="prior_probability_bound" />
    <NotebookCell cellName="prior_odds_bound" />
    #### New evidence
    <NotebookCell cellName="partial_match_weight_bound" />
    <NotebookCell cellName="bayes_factor" />
    <NotebookCell cellName="narrative" />
    <NotebookCell cellName="chart" />
