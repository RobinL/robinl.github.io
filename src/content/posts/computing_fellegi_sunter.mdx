...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/notebooks/migrated/computing-the-fellegi-sunter-model/0068042ce3b10dd1@284.notebook.html"
...
## Computing the prediction step by step
    ...
    ### Input table 1
    <NotebookCell cellName="input_table_l" className="observableTableWithScrollbar"/>

    ### Input table 2:
    <NotebookCell cellName="input_table_r" className="observableTableWithScrollbar"/>
    ...
    <NotebookCell cellName="comparison_pairs_no_gamma" className="observableTableWithScrollbar"/>
    <p class="table-note">Table scrolls right →</p>

    At first glance, it may seem challenging to turn this table of text into a numeric prediction.  But this can be achieved using the concepts of <DefinitionToolTip term="scenario" />s and <DefinitionToolTip term="partial_match_weight" />s <a href="/partial_match_weights/">introduced earlier in this tutorial</a>.
    ...
    <NotebookCell cellName="lookup_table" className="observableTableWithScrollbar"/>
...
<p class="table-note">Table scrolls right →</p>
    ...
    <NotebookCell cellName="comparison_vector_values_only" />
    ...
    <NotebookCell cellName="cv_pmw_sum" className="observableTableWithScrollbar"/>
    <p class="table-note">Table scrolls right →</p>
    ...
    <NotebookCell cellName="raw_values_with_final_match_prob" className="observableTableWithScrollbar"/>
    <p class="table-note">Table scrolls right →</p>
