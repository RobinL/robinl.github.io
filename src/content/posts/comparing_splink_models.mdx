...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/comparing_splink_models.mdx"
...
<VegaLite client:visible spec={roc_comparison} />
...
<VegaLite client:visible spec={model_01_two_levels_bf} />
...
<VegaLite client:visible spec={model_02_fuzzy_simple_bf} />
...
<VegaLite client:visible spec={model_03_fuzzy_complex_bf} />
...
<VegaLite client:visible spec={runtimes} />
