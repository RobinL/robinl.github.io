...
The feedback system itself rarely has to be explicitly developed[^verification]: AI agents will already seek feedback without being asked - they will run tests, write new ones, inspect outputs and investigate failures. Our role is in judging whether the feedback is a good measure of success, and translating the problem into tasks of appropriate size based on the best feedback loop we can think of. **The stronger the feedback loop, the larger the task we can safely delegate.**
