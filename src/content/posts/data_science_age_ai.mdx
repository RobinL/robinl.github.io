...
How has AI changed our role? **Our job is increasingly to guide AI to good solutions, not to write code ourselves.**  The challenge is to translate problems into feedback loops that reliably steer agents in the right direction.
...
[^verification]: For instance, agents will run your unit test suite without being told to, they'll attempt to view images of output an interpret them and iterate and so on.
...
In these examples, pay attention to the interplay of three elements of the feedback loop:
