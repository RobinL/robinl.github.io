...
[^verification]: For instance, agents will run your unit test suite without being told to, they'll design a website then view it as an image to see if it look good, and so on.
