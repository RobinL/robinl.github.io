...
How has AI changed our role? [Paraphrasing](https://mrocklin.spicytakes.org/) [Matt Rocklin](https://matthewrocklin.com/ai-zealotry/): **Our job is increasingly to construct feedback systems that guide AI to good solutions, not to write code ourselves.**

Such feedback systems are crucial to the effective use of AI:  They are our main defence against slop and hallucinations, making reliable results a matter of skill rather than luck.

Luckily, data scientists are well placed to build these feedback systems because the underlying skills are familiar:  building solutions has always been an iterative process of designing and running experiments and evaluating performance.  The change is that we now need to design this structure in a way that enables it to be delegated to agents.
...
Of course, we need to be careful the AI is not overfitting here.  Human judgement was also important to this example: by looking at real-world examples of true and false positives, I could see feature makes intuitive sense as an important signal, increasing my confidence that it can genuinely increase accuracy.
...
- Agents will become better at managing memory and context, remembering much more about the full history of a project: past experiments, successess, failures, and project conventions and preferences.
