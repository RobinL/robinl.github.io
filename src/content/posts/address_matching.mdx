...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/address_matching.mdx"
probLinkageCategory: "other_articles"
latestUpdate: "2025-06-30"
pageWidth: "prose"
---

import Subtitle from '../../components/probabilistic/Subtitle.jsx';
import AddressComparison from '../../components/probabilistic/AddressComparison.jsx';
import AddressCandidatesComparison from '../../components/probabilistic/AddressCandidateComparison.jsx';
...
Unfortunately one of the most effective general approaches to record linkage – known as the <a href="/intro_to_probabilistic_linkage/">Fellegi-Sunter model</a> and implemented in [Splink](http://github.com/moj-analytical-services/splink) – is not well suited to address matching because:
...
<div className="address-token-list">
  <code><mark>1</mark> Rainbow Lane Taunton TA1 1AB</code>
  <code><mark>2</mark> Rainbow Lane Taunton TA1 1AB</code>
  <code><mark>Highfield</mark> Rainbow Lane Taunton TA1 1AB</code>
  <code><mark>Old Station House</mark> Rainbow Lane Taunton TA1 1AB</code>
  <code><mark>5</mark> Rainbow Lane Taunton TA1 1AB</code>
</div>
...
Another powerful approach for matching is a fault tolerant trie, see separate article <a href="/fault_tolerant_trie/">here</a>.
