...
postDate: "2025-03-16"
category: "data"
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/recommend_duckdb.mdx"
pageWidth: "prose"
---
...
An <a href="/recommend_sql/">earlier post</a> explains why I favour SQL over other APIs such as [Polars](https://pola.rs/), [pandas](https://pandas.pydata.org/) or [dplyr](https://dplyr.tidyverse.org/).
