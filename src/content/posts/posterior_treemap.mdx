...
<NotebookCellProvider client:visible notebook="updating-a-prior-simplified">
    ...
    $	ext{match probability} = \frac{\colorbox{yellow}{\text{yellow area}}}{\colorbox{yellow}{\text{yellow area}} + \colorbox{#35cbff}{\text{blue area}}}$

    The yellow area is $\lambda m$ and the blue area is $(1-\lambda)u$.
