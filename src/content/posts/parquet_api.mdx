...
postDate: "2023-01-09"
category: "data"
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/parquet_api.mdx"
latestUpdate: "2023-09-21"
pageWidth: "prose"
---
...
## Some updates since this was first published:

- The French National Institute of Statistics and Economic Studies (Insee) have started publishing open data in parquet format that can be immediately analysed in the DuckDB shell.  See [here](https://twitter.com/ericMauviere/status/1698962876973592964).  It can be immediately manipulated in SQL using DuckDB in Observable - see [here](https://observablehq.com/@fil/insee-parquet)

- I love this comment [from Hacker News](https://news.ycombinator.com/item?id=37528076), in response to a [post](https://news.ycombinator.com/item?id=37526047) entitled: "My favourite API is a zipfile on the European Central Bank's website"
