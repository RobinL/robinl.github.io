...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/fault_tolerant_trie.mdx"
...
<ObservableCellProvider client:visible notebook="fault-tolerant-trie">
