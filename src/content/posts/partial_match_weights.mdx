...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/notebooks/migrated/partial-match-weights/8fa206ca7e295acc@509.notebook.html"
...
<NotebookCellProvider client:visible notebook="partial-match-weights">
    <NotebookCell cellName="input_table" />
    ...
    <NotebookCell cellName="waterfall_highlight" />

    Alternatively we can represent the calculation of overall match weight as a sum:

    <NotebookCell cellName="waterfall_as_formula" />
    ...
    <NotebookCell cellName="probability_formula" />
