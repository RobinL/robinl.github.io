...
| --- | --- | --- | --- |
| Robin | Linacre | W1A 1AA | Female |
| Robyn | Linacre | W1A 1AA | Male |
...
For date of birth, we may define three comparison levels, but <DefinitionToolTip term="levenshtein" text="Levenshtein" /> would be more suitable than <DefinitionToolTip term="jaro_winkler" text="Jaro Winkler" /> for assessing similarity.
