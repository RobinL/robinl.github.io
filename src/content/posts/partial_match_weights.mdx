...
2. Fuzzy match:  First names are similar according to the <DefinitionToolTip term="jaro_winkler" text="Jaro Winkler" /> measure.
3. All other cases
...
For date of birth, we may define three scenarios, but <DefinitionToolTip term="levenshtein" text="Levenshtein" /> would be more suitable than <DefinitionToolTip term="jaro_winkler" text="Jaro Winkler" /> for assessing similarity.
