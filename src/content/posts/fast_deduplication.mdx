...
codeUrl: "https://github.com/RobinL/robinl.github.io/blob/dev/src/mdx/fast_deduplication.mdx"
probLinkageCategory: "benchmarking"
pageWidth: "prose"
---
...
<VegaLite client:visible spec={summary_chart} />
...
[^2]: Please <a href="/about/">contact me</a> if you know otherwise!
...
<VegaLite client:visible spec={by_function_chart} />
...
<VegaLite client:visible spec={cpu_mem_chart} />
...
- Splink is able to effectively harness most of the information in the input data in making a prediction - as explained in <a href="/fellegi_sunter_accuracy/">this post</a>.
...
- Splink offers a range of configuration options to optimise accuracy which are detailed further in <a href="/comparing_splink_models/">this post</a>.
...
<VegaLite client:visible spec={spark_vs_duckdb_chart} />
...
<VegaLite client:visible spec={metrics_spark_filtered} />
...
-  <a href="/intro_to_probabilistic_linkage/">Interactive introduction to probabilistic record linkage</a>.
