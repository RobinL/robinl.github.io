...
export const renderTraceStepsTable = (trace, options = {}) => {
  const {
    showReason = true,
    showDetails = true,
...
export const hard_coded_addresses = `1 HIGH STREET WESTMINSTER
...
export const initial_list_of_addresses = `1 RAINBOW ROAD ABBOTS LANGLEY
