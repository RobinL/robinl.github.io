// https://observablehq.com/@robinl/spark-explain@647
import define1 from "./146f352f1166f0d1@2202.js";

function _title(md){return(
md`# Spark UI SQL detailed annotator`
)}
...
function _output_svg(plot_plan,raw_svg){return(
plot_plan(raw_svg)
)}
...
function _raw_svg(d3,html,raw_html)
...
function _plot_plan(svg,d3,get_text_content_spaces,get_definitions_from_text,html,$){return(
function plot_plan(raw_svg){
  ...
  elems.selectAll(".node").on("mouseover", function() {
    ...
    let final_text = html` ${defs} <p><strong>Original tooltip: </strong>${original_tooltip_text}</p>`
  ...
  elems.selectAll(".cluster").on("mouseover", function() {
    ...
    let contents = html`${get_definitions_from_text(cluster_contents_text)}`
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("output_svg")).define("output_svg", ["plot_plan","raw_svg"], _output_svg);
  ...
  main.variable(observer("raw_svg")).define("raw_svg", ["d3","html","raw_html"], _raw_svg);
  main.variable(observer("plot_plan")).define("plot_plan", ["svg","d3","get_text_content_spaces","get_definitions_from_text","html","$"], _plot_plan);
  ...
  main.variable(observer("styles2")).define("styles2", ["html"], _styles2);
